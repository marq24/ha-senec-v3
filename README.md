...
> [!IMPORTANT]  
> Please don't fork this repositiory, use the original one and cherry pic from me !
...
There is a short [tutorial/guide 'How to provide DEBUG log' here](docs/HA_DEBUG.md) - please take the time to quickly go through it. [open link from external (HACS)](https://github.com/marq24/ha-senec-v3/blob/main/docs/HA_DEBUG.md)
...
See all the details in the [LOAD YOUR BATTERY_WITH_TIBBER](https://github.com/marq24/ha-senec-v3/blob/main/docs/battery_control/BATTERY_WITH_TIBBER.md).
